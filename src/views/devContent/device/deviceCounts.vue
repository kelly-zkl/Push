<template>
  <section>
    ...
    <el-table :data="devices" highlight-current-row v-loading="listLoading"
      ...
      <el-table-column label="设备标签" min-width="250" sortable align="center"
                       :formatter="formatTags"></el-table-column>
      <el-table-column label="设备别名" min-width="250" sortable align="center"
                       :formatter="formatAlias"></el-table-column>
      <el-table-column label="设备群组" min-width="250" sortable align="center"
                       :formatter="formatGroups"></el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      formatTags(row, column) {
        ...
        if (row.tags.length > 0) {
          ...
          return taglist.substr(0, taglist.length - 1)
        } else {
          return "--";
        }
      },
    ...
    mounted() {
      this.appId = this.$route.query.appId || sessionStorage.appId;
